...
namespace locker.Controllers
{
    public class GestionDeLibroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NombreLibro,Estado,Autor,Introduccion,Genero,Editorial,PaginaActual,Arboles")] GestionDeLibro gestionDeLibro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NombreLibro,Estado,Autor,Introduccion,Genero,Editorial,PaginaActual,Arboles")] GestionDeLibro gestionDeLibro)
        {
            if (ModelState.IsValid)
            {
